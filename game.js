...
let gameLoop = setInterval(() => {
  ...
  if (collisionDetection(player, obstacleFactory.obstacles) && lives.livesRemaining > 1) {
    lives.livesRemaining--;
    lives.removeLives();
  } else if ((collisionDetection(player, obstacleFactory.obstacles)) && lives.livesRemaining === 1) {
